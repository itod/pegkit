...
enum {
    ...
    EXPRESSIONACTIONS_TOKEN_KIND_GE_SYM,
    EXPRESSIONACTIONS_TOKEN_KIND_COMMA,
    EXPRESSIONACTIONS_TOKEN_KIND_OR,
    EXPRESSIONACTIONS_TOKEN_KIND_LT_SYM,
    EXPRESSIONACTIONS_TOKEN_KIND_LE_SYM,
    EXPRESSIONACTIONS_TOKEN_KIND_EQUALS,
    EXPRESSIONACTIONS_TOKEN_KIND_DOT,
    EXPRESSIONACTIONS_TOKEN_KIND_GT_SYM,
    ...
    EXPRESSIONACTIONS_TOKEN_KIND_NOT_EQUAL,
